			...
			<div class="col-span-12 md:col-span-6">
				<div class="h-full px-5 py-8 shadow-inner rounded-standard">
					...
					<div class="flex gap-6">
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/bank.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/bank.png"
								alt="Банковские перечисление" title="Банковские перечисление" class="" width="60" height="60">
						</picture>
						<picture>
							<source srcset="<?= SITE_TEMPLATE_PATH; ?>/images/cash.webp" type="image/webp"><img src="<?= SITE_TEMPLATE_PATH; ?>/images/cash.png"
								alt="Наличный расчет" class="" title="Наличный расчет" width="60" height="60">
						</picture>
					</div>
				</div>
			</div>
