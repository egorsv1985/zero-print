	...
	<ul class="flex items-center justify-between gap-2 max-w-36">
		<? if ($insta_link) : ?>
			<li class="social__item">
				<a href="<?= $insta_link ?>" target="_blank" class="flex items-center justify-center transition duration-500 bg-white rounded-full size-9 group/messengers">
		...
		<? if ($vb_link) : ?>
			<li class=" social__item">
				<a href="<?= $vb_link ?>" target="_blank" class="flex items-center justify-center transition duration-500 bg-white rounded-full size-9 group/messengers">
		...
		<? if ($tictoc_link) : ?>
			<li class="social__item">
				<a href="<?= $tictoc_link ?>" target="_blank" class="flex items-center justify-center transition duration-500 bg-white rounded-full size-9 group/messengers">
